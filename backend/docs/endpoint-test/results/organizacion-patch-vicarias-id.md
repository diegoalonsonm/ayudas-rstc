...
- timestamp: 2026-09-08T14:24:54.130Z
- durationMs: 2
...
```http
PATCH http://localhost:3000/api/v1/vicarias/00000000-0000-0000-0000-000000000000
Content-Type: application/json
Authorization: (missing tokenAcceso)

{
  "nombre": "Vicaría TEST 1788877468590 actualizado"
}
```
