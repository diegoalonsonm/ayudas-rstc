...
- timestamp: 2026-09-08T14:24:54.145Z
- durationMs: 4
...
```http
PATCH http://localhost:3000/api/v1/parroquias/00000000-0000-0000-0000-000000000000
Content-Type: application/json
Authorization: (missing tokenAcceso)

{
  "nombre": "Parroquia TEST 1788877468590 actualizado"
}
```
